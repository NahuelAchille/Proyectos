const ingresos = [
    ...
    new Ingreso("Ventas", 2400),
];
const egresos = [
    new Egreso("Alquiler", 1000.00),
    new Egreso("Compras", 600.00)
];
...
let eliminarEgreso = (idEgresos)=>{
    let indiceEliminar = egresos.findIndex(egreso => egreso.idEgresos === idEgresos );
